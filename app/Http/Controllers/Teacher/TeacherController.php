...
class TeacherController extends Controller
{
    ...
    {
        try {
            return view('teachers_affairs/teachers.create_teacher');
    ...
    public function show()
    {
        try {
            ...
            return view('teachers_affairs/teachers.deleted_teachers',
                compact('teachers', ));
    ...
    public function edit($id)
    {
        try {
            ...
            return view('teachers_affairs/teachers.edit_teacher',
                compact('teacher'));
