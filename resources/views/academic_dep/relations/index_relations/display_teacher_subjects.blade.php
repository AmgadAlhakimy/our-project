    ...
    <div class="my-table">
        ...
        <div class="table-header">
            ...
            <div class="row first-card  ">
                <h4 class="col container-title mt-2">{{__('relations.display subjects for teachers')}}</h4>
            ...
            <div class="card table-section ">
                <table id="check_table">
                    ...
                    <tr>
                        ...
                        <th class="th-head-1">subject 1</th>
                        <th class="th-head-1">subject 2</th>
                        <th class="th-head-1">subject 3</th>
