    ...
    <div class="sidebar my-scroll">
        ...
        <div class="sidebar-nav ">
            <ul class="list-ul ">
                ...
                <li class="dropdown">
                    ...
                    <div class="submenu">
                        <div class="line-black">
                            ...
                            <a href='{{route('activity_classroom.create')}}'
                ...
                <!-- ========== 5 ============ -->
                <p class="title">{{__('sidebar.control section')}}<i
                        class="ms-1 me-1 fa-solid fa-person-chalkboard"></i></p>
                ...
                <!-- ========== 5 ============ -->
                <p class="title">{{__('sidebar.teacher section')}}<i
                        class="ms-1 me-1 fa-solid fa-person-chalkboard"></i></p>
                {{-- ---المعلمين--- --}}
                <!-- ======================== TEACHERS ========================== -->
                <li class="dropdown">
                ...
                {{-- ---شؤون الموظفين--- --}}
                <!-- ======================== EMB ========================== -->
                <p class="title">{{__('sidebar.personnel affairs section')}}<i
                        class="ms-1 me-1 fa-solid fa-users-between-lines"></i></p>
                <li class="dropdown">
                    <!-- ========== 2 ============ -->
                    <div class="sidebar-title">
                        <a href="#" class="li-link title-4">
                    ...
                    <div class="submenu">
                        <div class="line-black">
                            ...
                            <a href="{{route('teachers.show','deleted')}}"
                               class="li-link">{{__('sidebar.deleted teachers')}}</a>
                ...
                <li class="dropdown">
                    ...
                    <div class="submenu">
                        <div class="line-black">
                            ...
                            <a href='{{url('student_parent')}}'
                               class="li-link">{{__('add a Student with livewire')}}</a>
                            {{-- review students --}}
                            <a href="{{route('students.index')}}" class="li-link">{{__('sidebar.review students')}}</a>
                            <a href="{{route('students.show','deleted')}}"
                               class="li-link">{{__('sidebar.deleted Student')}}</a>
                            {{-- deleted students --}}
                            {{-- Student avsence --}}
