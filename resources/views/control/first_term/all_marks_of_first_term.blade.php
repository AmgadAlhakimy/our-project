        ...
        <div class="table-header">
            ...
            <div class="row ">
                ...
                <div class="text-center col row center_y_x me-1 ms-1">
                    ...
                    <div class="col row">
                        <label class="col title-5"> شهادة <span class="title-3">الترم الأول</span> </label>
                ...
                <table class=" mark_table" id="check_table" >
                    <thead >
                        <tr class="">
                            ...
                            <th class="th-hea">اختبار نهائي<div>30</div></th>
                ...
                <table class=" mark_table" id="check_table" >
                    <thead >
                        <tr class="">
                            ...
                            <th class="th-hea text-dark" colspan="2">سبعمائة درجه</th>
                        </tr>
                        <tr>
                            <th class="th-hea text-dark"> المعدل<div>100%</div></th>
                            <th class="th-hea text-success" colspan="">100%</th>
                            <th class="th-hea text-dark" colspan="">الترتيب</th>
                            <th class="th-hea text-info bg-success" colspan="">الأول</th>
                            <th class="th-hea text-dark">التقدير</th>
                            <th class="th-hea text-success" colspan="">ممتاز</th>
                            <th class="th-hea text-dark" colspan="">النتيجة النهائية</th>
                            <th class="th-hea text-info bg-success" colspan="">ناجح</th>
                        </tr>
                    </thead>
                </table>
            </div>
