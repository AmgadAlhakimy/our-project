                ...
                <div class="container  containers-style ">
                    <div class="row">
                        ...
                        <div class="box col-lg-6 col-md-12">
                            <label for="father">{{__("CreateStudent.father's name in english")}}</label>
                        ...
                        <div class="box col-lg-6 col-md-12">
                            <label for="father_ar">{{__("CreateStudent.father's name in arabic")}}</label>
                        ...
                        <div class="box col-lg-6 col-md-6">
                            <label for="father_work">{{__("CreateStudent.father's work in english")}}</label>
                        ...
                        <div class="box col-lg-6 col-md-6">
                            <label for="father_work_ar">{{__("CreateStudent.father's work in arabic")}}</label>
                        ...
                        <!-- father contacts  -->
                        <div class="box ">
                            <label for="f-numbers">{{__("CreateStudent.father's contacts")}}</label>
                            <div class="row ">
                        ...
                        <!-- mother name  -->
                        <div class="box col-lg-6 col-md-12">
                            <label for="arab-mother-name">{{__("CreateStudent.mother's name in english")}}</label>
                        ...
                        <div class="box col-lg-6 col-md-12">
                            <label for="english-mother-name">{{__("CreateStudent.mother's name in arabic")}}</label>
                        ...
                        <!-- mother work  -->
                        <div class="box col-lg-6 col-md-6">
                            <label for="arab-mother-work">{{__("CreateStudent.mother's work in english")}}</label>
                        ...
                        <div class="box col-lg-6 col-md-6">
                            <label for="work">{{__("CreateStudent.mother's work in arabic")}}</label>
                        ...
                        <!-- mother contacts  -->
                        <div class="box ">
                            <label for="m-numbers">{{__("CreateStudent.mother's contacts")}}</label>
                            <div class="row ">
                        ...
                        <!-- garden name  -->
                        <div class="box col-lg-6 col-md-12">
                            <label for="name-a">{{__('CreateStudent.kin name in english')}}</label>
                        ...
                        <div class="box col-lg-6 col-md-12">
                            <label for="name-e">{{__('CreateStudent.kin name in arabic')}}</label>
                        ...
                        <!-- garden relationship -->
                        <div class="box col-lg-6 col-md-6">
                            <label for="relation-a">{{__('CreateStudent.kin relationship in english')}}</label>
                        ...
                        <div class="box col-lg-6 col-md-6">
                            <label for="relation-e">{{__('CreateStudent.kin relationship in arabic')}}</label>
                        ...
                        <!-- garden number  -->
                        <div class="box col">
                            <label for="number">{{__('CreateStudent.kin contact')}}</label>
