...
{{-- قم بمراجعه الصفحة يمكن مسحها او لا --}}
    ...
    <main class="main">
        <section class="section ">
            ...
            <form method="post" action="{{route('students.store')}}" enctype="multipart/form-data">
                @csrf
                <!-- Start personal info  -->
                <h3 class="container-title">{{__('create CreateStudent')}}</h3>
                <div class="container containers-style ">
                    <div class="row ">
                        ...
                        <div class="box col-lg-2 col-md-2 col-sm-12">
                            <label class="" for="photo">{{__('CreateStudent.photo')}}</label>
                        ...
                        <div class="box col-lg-5 col-md-5 col-sm-12 ">
                            <label for="address">{{__("CreateStudent.CreateStudent's address in arabic")}}</label>
                        ...
                        {{-- -- --}}
                        <div class="box col-lg-5 col-md-5 col-sm-12 ">
                            <label for="address">{{__("CreateStudent.CreateStudent's address in english")}}</label>
                        ...
                        <input type="hidden" name="gender_ar_m" value="{{__('CreateStudent.male_ar')}}">
                        <input type="hidden" name="gender_ar_f" value="{{__('CreateStudent.female_ar')}}">
                        {{-- 6 --}}
                        <div class="box col-lg-3 col-md-4 col-sm-6">
                        ...
                        <div class="box col-lg-6 col-md-8 col-sm-12">
                            <label for="className" class="title-3">{{__('CreateStudent.level')}}</label>
                ...
                {{-- <!-- Start parent info  --> --}}
                <h3 class="container-title">{{__('CreateStudent.parent info')}}</h3>
                <div class="container  containers-style ">
                    <div class="row">
                        <!-- father name  -->
                        <div class="box ">
                        ...
                        <div class="box ">
                            <label for="className " class="title-3">{{__('CreateStudent.parent info')}}</label>
                ...
                <div class="container containers-style mb-5">
                    <div class="row">
                        <div class="box col-lg-12 col-md-12">
                            <h4 class="p-1 ">{{__('CreateStudent.does the CreateStudent')}}</h4>

                            {{-- 1 --}}
                            <label class="mt-4">{{__('CreateStudent.take any medicine ?')}}</label>
                            {{-- ---- --}}
                            <div class="row ">
                            ...
                            {{-- 2 --}}
                            {{-- -------------------------------- --}}
                            <label class="mt-4">{{__('CreateStudent.have an allergy ?')}}</label>
                            {{-- ---- --}}
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                            ...
                            {{-- 3 --}}
                            {{-- -------------------------------- --}}
                            <label class="mt-4">{{__('CreateStudent.have any health problem ?')}}</label>
                            {{-- ---- --}}
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                ...
                <div class="container containers-style">
                    <div class="row">
                        <div class="box col-lg-12 col-md-12">
                            <label class="title-3" for="std_Note">{{__('CreateStudent.note')}}</label>
