        ...
        <div class="container containers-style mb-5">
            <div class="row">
                <div class="box col-lg-12 col-md-12 row">
                    ...
                    {{-- -------------------------------- --}}
                    <div class="box row text-center">
                        <label class="col d-flex justify-content-end">{{__('student.have an allergy ?')}}</label>
                        {{-- ---- --}}
                        <div class="col mt-2 d-flex justify-content-start">
                            <input class="toggle " type="checkbox" wire:model.live.debounce.500ms="studentForm.have_allergy"
                                   id="haveAllergy"
                                   value="{{old('have_allergy')}}" onchange="toggleInput()">
                            <label class="form-label rounded" for="haveAllergy"></label>
                        </div>
                        <div class="row">
                            {{-- -*- --}}
                    ...
                    {{-- -------------------------------- --}}
                    <div class="box row text-center">
                        <label class="col d-flex justify-content-end">{{__('student.have any health problem ?')}}</label>
                        {{-- ---- --}}
                        <div class="col mt-2 d-flex justify-content-start">
                            <input class="toggle" type="checkbox" wire:model.live.debounce.500ms="studentForm.have_health_problem"
