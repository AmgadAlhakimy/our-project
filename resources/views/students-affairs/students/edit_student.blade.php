...
@section('content')
    <main class="main">
        <section class="section ">
            ...
            @endif
                <h3 class="container-title">{{__('CreateStudent.update CreateStudent: ').$student->name}}</h3>
                <form method="post" action="{{route('students.update', $student->id)}}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <!-- Start personal info  -->
                <h3 class="container-title">{{__('CreateStudent.CreateStudent info')}}</h3>
                <div class="container containers-style ">
                    <div class="row">
                        {{-- 1 --}}
                        <div class="box col-lg-6 col-md-12">
                            <label class="  title-3 "
                            for="english-name">{{__("CreateStudent.CreateStudent's name in arabic")}}</label>
                        ...
                        <div class="box col-lg-6 col-md-12">
                            <label class="text-center"
                                for="arab-name">{{__("CreateStudent.CreateStudent's name in english")}}</label>
                        ...
                        <div class="box row">
                            <label for="address">{{__('CreateStudent.addresses')}}</label>
                            <div class="col-lg-6 col-md-6">
                                <span class=" text-center title-3 ">{{__("CreateStudent.CreateStudent's address in arabic")}}</span>
                            ...
                            <div class="col-lg-6 col-md-6 ">
                                <span
                                    class=" text-center title-3 ">{{__("CreateStudent.CreateStudent's address in english")}}</span>
                        ...
                        <div class="box col-lg-6 col-md-6 ">
                            <label for="gender">{{__('CreateStudent.gender')}}</label>
                            <select class="col form-select form-control" id="gender" name="gender">
                                <option class="text-center"
                                        value="{{__('CreateStudent.male')}}" @if($student->getTranslation('gender','en') == 'male') selected @endif>
                                    {{__('CreateStudent.male')}}</option>
                                <option class="text-center"
                                        value="{{__('CreateStudent.female')}}"  @if($student->getTranslation('gender','en') == 'female') selected @endif>
                                    {{__('CreateStudent.female')}}</option>
                            </select>
                            @error('gender')
                            <small class="form-text text-danger">{{$message}}</small>
                            @enderror
                        ...
                        {{-- 6 --}}
                        <div class="box col-lg-6 col-md-6">
                            <label for="age">{{__('CreateStudent.birthdate')}}</label>
                        ...
                        {{-- 7 --}}
                        <div class="box col-lg-6 col-md-6">
                            <label for="english-birth-place">{{__('CreateStudent.place of birth in arabic')}}</label>
                        ...
                        {{-- 8 --}}
                        <div class="box col-lg-6 col-md-6">
                            <label for="arabic-birth-place">{{__('CreateStudent.place of birth in english')}}</label>
                        ...
                        {{-- 8 --}}
                        <div class="box ">
                            <label for="className " class="form-label">{{__('CreateStudent.class')}}</label>
                ...
                <!-- Start health info  -->
                <h3 class="container-title">{{__('CreateStudent.health info')}}</h3>
                <div class="container containers-style mb-5">
                    <div class="row">
                        <div class="box col-lg-12 col-md-12">
                            <h4 class="p-2">{{__('CreateStudent.does the CreateStudent')}}</h4>
                            <label class="mt-3">{{__('CreateStudent.take any medicine ?')}}</label>
                            ...
                            <label class="mt-3">{{__('CreateStudent.have an allergy ?')}}</label>
                            <div class="input-group mt-2 mb-2">
                            ...
                            <label class="mt-3">{{__('CreateStudent.have any health problem ?')}}</label>
                            <div class="input-group mt-2 mb-2">
                ...
                <!-- End health info  -->
                <!-- Start final box -->
                <h3 class="container-title">{{__('CreateStudent.other info')}}</h3>
                <div class="container containers-style">
                    <div class="row">
                        <div class="box col-lg-12 col-md-12">
                            <label class="form-label" for="std_Note">{{__('CreateStudent.note')}}</label>
