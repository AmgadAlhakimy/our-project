                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <img src="{{URL::asset(path: 'assets/images/home/user.jpg')}}" class="rounded-circle flex-shrink-0" alt="" style="width: 45px; height: 45px;" />
                                    <div class="ms-3">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="classes-item">
                            ...
                            <div class="bg-light rounded p-4 pt-5 mt-n5">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center">
                                        <img src="{{URL::asset(path: 'assets/images/home/user.jpg')}}" class="rounded-circle flex-shrink-0" style="width: 45px; height: 45px;" alt="" />
                                        <div class="ms-3">
                                            <h6 class="text-primary mb-1">Jhon Doe</h6>
                                            <small>Teacher</small>
                                        </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="row g-2 pt-2">
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="{{URL::asset(path: 'assets/images/home/classes-1.jpg')}}" class="" alt="" />
                            </div>
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="{{URL::asset(path: 'assets/images/home/classes-2.jpg')}}" class="" alt="" />
                            </div>
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="{{URL::asset(path: 'assets/images/home/classes-3.jpg')}}" class="" alt="" />
                            </div>
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="{{URL::asset(path: 'assets/images/home/classes-4.jpg')}}" class="" alt="" />
                            </div>
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="{{URL::asset(path: 'assets/images/home/classes-5.jpg')}}" class="" alt="" />
                            </div>
                            <div class="col-4">
                                <img class="img-fluid rounded bg-light p-1" src="{{URL::asset(path: 'assets/images/home/classes-6.jpg')}}" class="" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
