    ...
    <main class="main ">
        <section class="section card-body">
            ...
            <form method="post" action="{{route('majors.update',$major->id)}}">
                @method('PUT')
                @csrf
                <h3 class="container-title">{{__('major.update major')}}</h3>
                    ...
                    <div class="row">
                        <div class="row mt-2">
                            ...
                            <div class="box col-lg-12 col-md-12">
                                <label for="edu_name"
                                       for="c-name">{{__('major.major name in english')}}</label>
                            ...
                            <div class="col-md-1"></div>
                            <div class="box col-lg-12 col-md-12">
                                <label for="edu_name_ar">{{__('major.major name in arabic')}}</label>
                ...
                <div class="row mt-2">
                    <div class=" row">
                        ...
                        <div class="box  col">
                            <a href="{{route('display-majors')}}" class="btn clear-button"><i
