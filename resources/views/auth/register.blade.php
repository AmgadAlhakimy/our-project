    ...
    <div class="login_container">
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-text-input id="name" class="form-control pink_color" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
            ...
            <div class="flex items-center justify-end mt-4 box ">
                ...
                <x-primary-button class="ms-4 save-button">
                    <div class="title-3">
                        {{ __('Register') }}
                    </div>
                </x-primary-button>
