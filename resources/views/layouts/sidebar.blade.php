          ...
          <div class="sidebar-nav">
            <ul class="list-ul my-scroll">
              ...
              <li class="dropdown">
                ...
                <div class="submenu">
                  <div class="line-black">
                    <a href="#" class="li-link">اضافة نشاط</a>
                    <a href="#" class="li-link">اضافة فصل</a>
                    <a href="#" class="li-link">اضافة مرحلة دراسية</a>
                    <a href="#" class="li-link">اضافة مواد</a>
                  </div>
                </div>
              </li>
              <li class="dropdown">
                ...
                <div class="sidebar-title">
                  <a href="#" class="li-link title-4">
                    <i class="icon-1 fa-solid fa-window-restore"></i>
                    <span class="menu-name"> الحسابات </span>
                    <i class="fa-solid fa-chevron-down"></i>
                  </a>
                </div>
                <div class="submenu">
                  <div class="line-black">
                    <a href="#" class="li-link"> رسوم دراسية</a>
                    <a href="#" class="li-link"> رسوم تسجيل</a>
                    <a href="#" class="li-link">تقرير نصف السنة الحالي</a>
                    <a href="#" class="li-link">تقارير الرواتب </a>
                    <a href="#" class="li-link">تقارير السنة المالية </a>
                  </div>
                </div>
              </li>
              <div>
              ...
              <li class="dropdown">
                ...
                <div class="submenu">
                  <div class="line-black">
                    <a href="#" class="li-link">اضافة الدرجات الشهرية</a>
                    <a href="#" class="li-link">جاول الغياب</a>
              ...
              <li class="dropdown">
                ...
                <div class="submenu">
                  <div class="line-black">
                    <a href="#" class="li-link">اضافة مدرس</a>
              ...
              <li class="dropdown">
                ...
                <div class="sidebar-title">
                  <a href="#" class="li-link title-4">
                    <i class="icon-1 fa-solid fa-window-restore"></i>
                    <span class="menu-name">السكرتارية</span>
                    <i class="fa-solid fa-chevron-down"></i>
                  </a>
                </div>
                <div class="submenu">
              ...
              <li class="dropdown">
                ...
                <div class="submenu">
                  <div class="line-black">
                    <a href="#" class="li-link">اضافة طالب</a>
                    <a href="#" class="li-link">2</a>
                    <a href="#" class="li-link">3</a>
                    <a href="#" class="li-link">4</a>
                  </div>
              ...
              <li class="dropdown">
                ...
                <div class="submenu">
                  <div class="line-black">
                    <a href="#" class="li-link">دفتر المتابعة</a>
                    <a href="#" class="li-link">2</a>
                    <a href="#" class="li-link">3</a>
                    <a href="#" class="li-link">4</a>
                  </div>
