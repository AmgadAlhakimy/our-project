...
<li class="dropdown">
    ...
    <div class="sidebar-title">
        <a href="#" class="li-link title-4">
            ...
            <span class="menu-name">{{__('personnel_affairs.teachers affairs')}}</span>
...
<li class="dropdown">
    ...
    <div class="sidebar-title">
        <a href="#" class="li-link title-4">
            <i class="icon-1 fa-solid fa-user-tie"></i>
            <span class="menu-name">{{__('personnel_affairs.embloyee affairs')}}</span>
            <i class="icon-1 fa-solid fa-chevron-down"></i>
        </a>
    </div>
    <div class="submenu">
...
<li class="dropdown">
    ...
    <div class="sidebar-title">
        <a href="#" class="li-link title-4">
            <i class="icon-1 fa-solid fa-user-tie"></i>
            <span class="menu-name">{{__('personnel_affairs.records and absent')}}</span>
            <i class="icon-1 fa-solid fa-chevron-down"></i>
        </a>
    </div>
    <div class="submenu">
        <div class="line-black">
            ...
            {{-- translate --}}
            <a href="#" class="li-link">{{__('personnel_affairs.personnel records')}}</a> 
        </div>
    </div>
</li>