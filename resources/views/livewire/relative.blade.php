                ...
                <form wire:submit="storeRelative">
                    ...
                    <!-- father name  -->
                        <div class="box col-lg-6 col-md-12">
                            ...
                            <input type="text" class="form-control" id='father' wire:model.blur="relativeForm.father_name"
                        ...
                        <div class="box col-lg-6 col-md-6">
                            ...
                            <input type="text" class="form-control" id='father_work' wire:model="relativeForm.father_work"
                        ...
                        <div class="box col-lg-6 col-md-6">
                            ...
                            <input type="text" class="form-control" id='father_work_ar' wire:model="relativeForm.father_work_ar"
                        ...
                        <div class="box col-lg-6 col-md-6">
                            ...
                            <input type="text" class="form-control" id='arab-mother-work' wire:model="relativeForm.mother_work"
