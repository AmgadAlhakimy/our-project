                ...
                <div class="container containers-style ">
                    <div class="row">
                        ...
                        <div class="box col-lg-6 col-md-6 ">
                            ...
                            <select id="educational_level" class="form-control" name="educational_level"
                                    onchange="populateClassrooms()">
                        ...
                        <div class="box col-lg-12 col-md-12">
                            ...
                            <div class="row ">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                                    <input class="toggle col" type="checkbox" name="take_medicine" id="takeMedicineE"
                                ...
                                @enderror
                                {{-- -*- --}}
                                <input type="text" class=" form-control ms-1 me-1 col " name="medicine_desc"
                                ...
                                @enderror
                                {{-- -*- --}}
                                <input type="text" class=" form-control ms-1 me-1 col" name="medicine_desc_ar"
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                                    <input class="toggle col" type="checkbox" name="have_allergy" id="haveAllergy"
                                ...
                                @enderror
                                {{-- -*- --}}
                                <input type="text" class=" form-control ms-1 me-1 col" name="allergy_desc"
                                ...
                                @enderror
                                {{-- -*- --}}
                                <input type="text" class=" form-control ms-1 me-1 col" name="allergy_desc_ar"
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                                    <input class="toggle col" type="checkbox" name="have_health_problem"
                                ...
                                @enderror
                                {{-- -*- --}}
                                <input type="text" class=" form-control ms-1 me-1 col" name="health_problem_desc"
                                ...
                                @enderror
                                {{-- -*- --}}
                                <input type="text" class=" form-control ms-1 me-1 col" name="health_problem_desc_ar"
                ...
                <div class="container containers-style">
                    <div class="row">
                        <div class="box col-lg-12 col-md-12">
                            ...
                            <textarea name="note" class="form-control" id="std_Note" cols="50"
