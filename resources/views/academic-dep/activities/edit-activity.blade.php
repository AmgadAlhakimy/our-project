                ...
                <div class="container containers-style ">
                    <div class="row">
                        ...
                        <div class="box col-lg-6 col-md-12">
                            ...
                            <input type="text" class="form-control" id='activity-name-a' required name="name"
                                   value="{{$activity->getTranslation('name','en')}}">
                            @error('name')
                        ...
                        <div class="box col-lg-6 col-md-6">
                            ...
                            <input type="number" class="form-control " id='area-number' value="{{$activity->contact}}"
                        ...
                        <div class="box col-lg-6 col-md-6">
                            ...
                            <input type="date" class="form-control " id='date-activities' value="{{$activity->date}}"
                                   name="date">
                            @error('date')
                            <small class="form-text text-danger">{{$message}}</small>
                            @enderror
                    ...
                    <div class="row">
                        <div class="box col-lg-12 col-md-12">
                            ...
                            <textarea class="form-control" id="std_Note" cols="50" rows="5"
                                      name="note">{{$activity->note}}</textarea>
                            @error('note')
                            <small class="form-text text-danger">{{$message}}</small>
                            @enderror
                        </div>
