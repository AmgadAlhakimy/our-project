                ...
                {{ $this->progress < 40 ? '#f87171' : ($this->progress < 80 ? '#facc15' : '#22c55e') }};">
                    ...
                    <ul class="list-none space-y-1">
                        <li class="flex items-center gap-1">
                            <i class="{{ $passwordRequirements['min'] ? 'fas fa-check text-success' : 'fas fa-times text-danger' }} text-xs"></i>
                            <span
                                class="{{ $passwordRequirements['min'] ? 'text-success' : 'text-danger' }} text-xs">{{trans('auth.min')}}</span>
                        </li>
                        <li class="flex items-center gap-1">
