                    ...
                    <tr>
                        ...
                        <td>
                            <div class="mt-2 check_style">
                                <label >
                                    <input class=" " type="checkbox" name=""  id="" value="<?php echo e(old('')); ?>"  >
                                    <i></i>
                                </label>
                            </div>
                        </td>
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My-Github\our-project\resources\views/teachers-affairs/absence/new-presenting.blade.php ENDPATH**/ ?>
