...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="box  col-lg-6 col-md-12">
                            ...
                            <input type="text" class="form-control" id='t-qualification_ar' name="qualification_ar"
                                    value="<?php echo e(old('qualification_ar')); ?>">
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My-Github\our-project\resources\views/employees-affairs/teachers/create-teacher.blade.php ENDPATH**/ ?>
