                    ...
                    <div class="row">
                        ...
                        <div class="box ">
                            ...
                            <div class="w-100 mt-5">
                                <a href='/parent_into'class=" save-button  w-full mt-3 p-3"><?php echo e(__('student.parent info')); ?></a>
                            </div>
                        </div>
                        <!-- garden number  -->
                    </div>
                        ...
                        <div class="box col-lg-12 col-md-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                                    <input class=" col" type="checkbox" name="take_medicine" id="takeMedicine" value="<?php echo e(old('take_medicine')); ?>" checked>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                                    <input class=" col" type="checkbox" name="have_allergy" id="takeMedicine "  value="<?php echo e(old('have_allergy')); ?>" checked>
                                    <label class="form-label col" for="takeMedicine"><?php echo e(__('student.yes')); ?></label>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-ms-12 mt-2">
                                    <input class=" col" type="checkbox" name="have_health_problem"  id="takeMedicine" value="<?php echo e(old('have_health_problem')); ?>" checked>
                                    <label class="form-label col" for="takeMedicine" id="takeMedicine"><?php echo e(__('student.yes')); ?></label>
                                </div>
