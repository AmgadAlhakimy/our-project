            ...
            <table class=" " >
                ...
                <?php $__currentLoopData = $marks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mark): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><input type="number" value="<?php echo e($mark->exam); ?>" name="exam" class=" form-control " id='Exam-Mark' placeholder="_" min="0" max="60"></td>
                        <td><input type="number" value="<?php echo e($mark->homework); ?>" name="homework" class=" form-control " id='HW-Mark' placeholder="_" min="0" max="20"></td>
                        <td><input type="number" value="<?php echo e($mark->oral); ?>" name="oral" class=" form-control " id='Oral-Mark' placeholder="_" min="0" max="10"></td>
                        <td><input type="number" value="<?php echo e($mark->behavior); ?>" name="behavior" class=" form-control " id='behavior-Mark' placeholder="_" min="0" max="10"></td>
