...
=======
                    <div class="box row">
                        <div class="notes col-lg-6 col-md-6 col-sm-12">
                            <a href="<?php echo e(route('class_subject.create')); ?>" class="li-link">
                                <button class="relation-button pt-5 pb-5 " id="" cols="50" rows="5">
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My-Github\our-project\resources\views/academic_dep/relations/relations-page.blade.php ENDPATH**/ ?>