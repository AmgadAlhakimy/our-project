        ...
        <section class="section ">
            ...
            <div class="container containers-style">
                    ...
                    <div class="notes col-lg-6 col-md-6 col-sm-12">
                        ...
                        <a href="<?php echo e(route('class-subjects.create')); ?>" class="li-link">
                    ...
                    <a href="/class-teacher" class="li-link">
                        ...
                        <div class="notes col-lg-12 col-md-12 col-sm-12">
                            <a  href="<?php echo e(route('subject-teachers.create')); ?>" class="li-link">
                                <button class="relation-button pt-5 pb-5 " id="" cols="50" rows="5">
...
<?php echo $__env->make('layouts.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\My-Github\our-project\resources\views/academic-dep/relationships/relationships-page.blade.php ENDPATH**/ ?>
